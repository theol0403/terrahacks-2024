...
{ "contain_endangered": true, "endangered_species": "spotted turtle", "fun_fact": "Hello there! I noticed you were learning about spotted turtles and moose! Did you know spotted turtles are totally black in color and contains anywhere from zero to about one hundred yellow spots, which are a defining characteristic of them? If you want to learn more, click the button to play a game!", "garbage": true }
{ "contain_endangered": false, "endangered_species": "", "fun_fact": "", "garbage": false }
{ "contain_endangered": true, "endangered_species": "gazelle", "fun_fact": "Howdyy!! What did the gazelle say to the lemur (insert joke here). Did you know this fun fact? Click the button to play a game!", "garbage": false }
